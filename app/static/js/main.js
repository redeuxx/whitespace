...
function initWhitespace() {
    ...
    document.querySelectorAll('.notification .delete').forEach(btn => {
        btn.addEventListener('click', () => { var _a; return (_a = btn.closest('.notification')) === null || _a === void 0 ? void 0 : _a.remove(); });
    });
    ...
    document.querySelectorAll('pre code.hljs-target').forEach(block => {
        ...
        (_a = block.closest('pre')) === null || _a === void 0 ? void 0 : _a.prepend(gutter);
    ...
    document.querySelectorAll('.toggle-password').forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            icon === null || icon === void 0 ? void 0 : icon.classList.toggle('fa-eye', !isHidden);
            icon === null || icon === void 0 ? void 0 : icon.classList.toggle('fa-eye-slash', isHidden);
        });
    });
